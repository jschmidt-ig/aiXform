ChatGPT Folder > AI SDLC Course Productization > Lecture-Series-23min-Episodes.md
# Lecture Series Syllabus — 23-Minute Episodes (Enterprise AI SDLC)

Design intent:
- Each episode is **23 minutes** so it fits calendar blocks and stays “watchable”
