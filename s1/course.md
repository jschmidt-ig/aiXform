...
* **Gross margin target + operational rationale**
  ...
  * Target **60% blended**, with **≥50% floor** on Accelerator (the high-touch tier) by strictly limiting coach hours per participant and pushing everything possible into reusable assets + automated assessment
...
### 2.1 One-page product brief (table)
...
### 2.2 Tier comparison table (pricing/packaging)
...
**Pricing signals used** (for defensibility): Foundations $300–$500/seat; Practitioner $2,000–$3,000/participant; Accelerator $30k–$50k team pack or $8k–$15k/participant 

### 2.3 Operational load model (what scales vs live time)

Assumptions (from inputs): Tier cohort targets 100–200 / 20–25 / 3–5 
...
Margin implication: the model preserves gross margin by keeping Practitioner to ~6–7 hrs/wk and Accelerator to ~8–10 hrs/wk per team, consistent with the need to keep high-touch seats limited 

### 2.4 Client responsibilities table

| Area                 | Client responsibility                                                                                                                                                  | Why it matters                                             |
| -------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------- |
| Repos & environments | Provide access to at least one “training repo” (can be sanitized) and a target brownfield repo for analysis; provision safe sandbox if production access is restricted | Enables “safe sandbox → brownfield” progression            |
| Tool approvals       | Approve model(s), IDE/CLI tooling, and any internal gateways by end of Week 1; define escalation path with security/IT                                                 | Prevents early stall; aligns with Week-1 contingency need  |
...
KPI tracking should use controllable + lagging measures (cycle time, PR frequency, coverage, docs completeness, adoption, satisfaction) 

### 3.2 Two on-ramps (delta-only)

**A) Greenfield track (delta-only)**
...
* Default assumption: approvals may lag; Week 1 must work without installing full CLI tooling 
...
* **Record:** every live demo, weekly Q&A, and “capstone review” session 
...
### 6.3 Competitive/market benchmarks (from research packet)

* Self-paced enterprise learning platforms commonly price **$200–$600/user/year**; team plans **$14–$30/user/month** 
* Instructor-led workshops **$500–$1,500/participant**; cohort programs **$2,000–$7,000/participant**; enterprise packages can be custom and much higher 
* Your tier pricing signals (Foundations/Practitioner/Accelerator) align with these benchmarks 

### 6.4 Sales narrative + objection handling

**Narrative (what you sell)**

* “We install a repeatable AI SDLC operating model under enterprise constraints: teams ship smaller, safer PRs with measurable improvements in cycle time, coverage, and documentation—without leaking code or violating PHI/PII policies.” 

**Common objections**

* “Security will never allow it.” → Program is designed for “no external SaaS/no code upload/approved models only” + redaction drills + prompt review workflow
...
2. Do you upload code to external tools? **No** (designed for “no code upload” environments). 
3. What if tooling approvals slip? Week-1 is designed to run with low-permission/offline exercises; schedule shifts without blocking. 
...
7. What metrics do you track? Cycle time, PR throughput, coverage, docs completeness, adoption, satisfaction. 
8. Is this “Copilot training”? No. It’s an SDLC workflow + governance model for enterprise constraints.
9. Do you provide certification? In v2 (see variants).
...
| Tool approvals slip    | Week 1–2 stalls       | Offline Week-1 plan; shift sequencing; security liaison escalation  |
...
### 8.1 MVP deliverable within 10 weeks (ship-now)
...
* Minimal async portal structure (just enough to distribute assets securely)

### 8.2 v2 scaled product within 6 months (scale + margin)
...
* Partner enablement: train-the-trainer kit + facilitator guide + grading calibration
* Stronger analytics: automated KPI ingestion where possible + executive dashboards 
...
* You can secure at least one approved model path for CLI-driven workflows within 2 weeks
* Clients will allow a sandbox repo that is non-sensitive for early labs
* Practitioner cohorts will hold at 20–25; Accelerator limited to ≤6 per pack 
